...
Library modified for capstone by Muhammad Usman....... a pretty cool guy
'''
...
class Bridge(object):
	...
	def __init__(self, ip=None, username=None, config_file_path=None):
		...
		# self.seconds = 10
		#if we make a blank call then go ahead and try to get the information.....
		
		#bla bla uoit specific problems IP address changes each time u connect..............
		
		if self.ip == None:
			self.get_ip_address(True)
			print ("using the IP addersss: " + self.ip )
		
#removed we dont need this in our condition...		
		#self.connect()
